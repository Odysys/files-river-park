...
function initFlash(){
var so = new SWFObject("PWViewer.swf", "sotester", "400", "300", "9.0.0", "#FFFFFF"); 
 so.addParam("allowNetworking", "all"); 
 so.addParam("allowScriptAccess", "always"); 
 so.addParam("allowFullScreen", "true"); 
 so.addParam("scale", "noscale"); 
 so.addVariable("configFileSize", "1.443"); 
 so.addVariable("zipResSize", "0.000"); 
 so.addVariable("sceneFilesSize", "1169.332"); 
 so.addVariable("base", "pano2/"); 
 so.addVariable("lwImg", "<!-%% Lw Img %%->"); 
 ...
 so.addVariable("iniFile", "config_pano2.bin"); 
